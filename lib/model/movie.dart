class Movie{
  String title,year,rated,released,runtime,genre,director,writer,actors,plot,
  language,country,awards,poster,metascore,imdbRating,imdbVotes,imdbID,type,response;
  List<String> images;
  ...
  static List<Movie> getmMovieList() => [
    Movie(
        "Avatar",
        "2009",
        "PG-13",
